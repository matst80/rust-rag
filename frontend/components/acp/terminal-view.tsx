...
export const TerminalView = memo(function TerminalView({
	...
	useEffect(() => {
		...
		const handleSnapshot = (e: Event) => {
			const customEvent = e as CustomEvent<{ data: string; cols: number; rows: number }>
		...
		return () => {
			...
			window.removeEventListener(`acp:term:snapshot:${terminalId}`, handleSnapshot)
			window.removeEventListener(`acp:term:resized:${terminalId}`, handleResized)
		}
	}, [terminalId])
